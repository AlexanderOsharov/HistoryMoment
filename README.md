...
## О проекте
Проект "Интерактивная карта местной истории" посвящен демонстрации исторических мест и развитию интереса к местному культурному наследию. Подробнее с проектом можно ознакомиться в документации [4].
